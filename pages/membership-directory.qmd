...
new_members <- read_excel(
  "../documents/CCPRO_Membership_Database_2026-09-19.xlsx",
  sheet = "New Membership"
) |> # Read in the directory from Excel: CCPRO_Membership_Database_YYYY_MM_DD.xlsx
  mutate(
    email = ifelse(
      !is.na(email) & email != "",
...
edit_members <- read_excel(
  "../documents/CCPRO_Membership_Database_2026-09-18.xlsx",
